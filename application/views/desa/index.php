<ol class="breadcrumb">
  <li class="breadcrumb-item active"><i class="fas fa-city fa-lg"> </i> &nbsp;&nbsp;&nbsp;Data Aparatur Desa</li>
</ol>
 	...
 	<div class="col-md-12">
        <div class="card shadow mb-4">
           	<div class="card-body">
            	<div class="row">
					<div class="col-md-12 ">
						<a href="<?= base_url('C_PerangkatDesa/tambah_data'); ?>" class="btn btn-primary btn-sm mb-2 "><!-- <i class="fas fa-plus">  -->Tambah Data<!-- </i> --></a>
						<a href="<?= base_url('C_PerangkatDesa/cetak_data'); ?>" class="btn btn-success btn-sm mb-2 "><!-- <i class="fas fa-print">  -->Cetak Data<!-- </i> --></a>
						<a href="<?= base_url('C_PerangkatDesa/daftar_kades'); ?>" class="btn btn-info btn-sm mb-2 "><!-- <i class="fas fa-print"> --> Daftar Pejabat <!-- </i> --></a>
		                  ...
		                  <?php $no=1; foreach($perangkat as $p): ?> 
		                        <tr>
		                          ...
		                          <td align="center">
		                            ...
		                            <a href="<?= base_url('C_PerangkatDesa/edit_perangkat/'.$p->id); ?>"  class="btn btn-info btn-sm mt-1"><!-- <i class="fa fa-edit fa-xs"></i> -->Edit</a>
...
<div class="modal fade" id="modal_hapus<?php echo $p->id;?>"  role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url('C_PerangkatDesa/hapus_perangkat');?>">
                <div class="modal-body">
