                ...
                <table class="table table-bordered" id="dataTables-example" width="100%" cellspacing="0" style="font-size: 16px;">
                  <thead>
                    ...
                    <?php $no=1; foreach($monitoring_desa as $k): ?>
                        <tr>
                          <td><?= $no++; ?></td>
                          <td style="text-align:center"><?= $k->nama_desa; ?></td>
                          <td align="center">
                                <a href="<?= base_url('C_FrontPage/monitoring_lihat_data_desa/'.$k->id_desa); ?>" class="btn btn-info btn-sm">Detail Data</a>

                                 <a href="<?= base_url('C_FrontPage/monitoring_histori_kades/'.$k->id_desa); ?>" class="btn btn-success btn-sm">Histori Kades</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                    </tbody>
