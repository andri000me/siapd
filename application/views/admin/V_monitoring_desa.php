                  ...
                  <thead>
                    ...
                    <?php $no=1; foreach($monitoring_desa as $k): ?>
                        <tr>
                          ...
                          <td align="center">
                                <a href="<?= base_url('C_admin/monitoring_lihat_data_desa/'.$k->id_desa); ?>" class="btn btn-info btn-sm">Detail Data</a>

                                 <a href="<?= base_url('C_admin/monitoring_histori_kades/'.$k->id_desa); ?>" class="btn btn-success btn-sm">Histori Kades</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                    </tbody>
