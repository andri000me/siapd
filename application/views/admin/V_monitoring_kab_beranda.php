		                ...
		                <tbody>
			                <?php $no=1; foreach($monitoring_kab as $k): ?>
			                    <tr>
			                    	...
			                    	<!-- <td><?= $jumlah; ?></td> -->
				                    <td align="center">
				                        <a href="<?= base_url('C_FrontPage/monitoring_kec/'.$k->id_kec); ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"> Lihat Desa</i></a>
				                        <a href="<?= base_url('C_FrontPage/monitoring_kec1/'.$k->id_kec); ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"> Lihat Kelurahan</i></a>
				                    </td>
			                    </tr>
			                <?php endforeach ?>
		                </tbody>
