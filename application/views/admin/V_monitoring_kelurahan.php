                  ...
                  <thead>
                    ...
                    <?php $no=1; foreach($monitoring_kelurahan as $k): ?>
                        <tr>
                          ...
                          <td align="center">
                                <a href="<?= base_url('C_admin/monitoring_lihat_data_kelurahan/'.$k->id_kel); ?>" class="btn btn-info btn-sm">Detail Data</a>

                                 <a href="<?= base_url('C_admin/monitoring_histori_lurah/'.$k->id_kel); ?>" class="btn btn-success btn-sm">Histori Lurah</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                    </tbody>
