...
<ol class="breadcrumb">
    ...
    <a href="<?= base_url('C_PerangkatDesa'); ?>" style="text-decoration: none"><i class="fas fa-city fa-lg"> </i>&nbsp;&nbsp;&nbsp;Data Aparatur Lurah</a>
  </li>
  <li class="breadcrumb-item active">Data Lurah Periode Lalu</li>
</ol>
